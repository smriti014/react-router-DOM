...
const Header = () => {
    return (
        <>
            <header class='flex shadow-[0px_4px_16px_rgba(17,_17,_26,_0.1),_0px_8px_32px_rgba(17,_17,_26,_0.05)] py-4 px-4 sm:px-6 bg-white font-[sans-serif] min-h-[75px] tracking-wide relative z-50'>
                <div class='flex flex-wrap items-center gap-5 w-full max-w-screen-xl mx-auto'>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/team"} href='javascript:void(0)'
                                class='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Team</NavLink>
                            </li>
                            <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/feature"} href='javascript:void(0)'
                                class='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Feature</NavLink>
                            </li>
                            <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/blog"} href='javascript:void(0)'
                                class='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Blog</NavLink>
                            </li>
                            <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/contact"} href='javascript:void(0)'
                                class='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Contact</NavLink>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class='flex items-center max-lg:ml-auto space-x-4'>
                        <button
                            class='px-3.5 py-[7px] text-[15px] rounded font-semibold text-[#007bff] border border-[#007bff] hover:bg-[#007bff] transition-all ease-in-out duration-300 bg-transparent hover:text-white'>Sign
                            up</button>
